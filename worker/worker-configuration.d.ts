/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c02f60affdd1de13b4d16de0657dbeca)
// Runtime types generated with workerd@1.20251105.0 2024-11-20 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LeagueState";
	}
	interface Env {
		LEAGUE_STATE: DurableObjectNamespace<import("./src/index").LeagueState>;
		STREAM_HUB: DurableObjectNamespace<import("./src/index").StreamHub>;
		VECTORIZE: VectorizeIndex;
		AI: Ai;
		EVALUATE_TRADE: Workflow<Parameters<import("./src/index").EvaluateTradeWorkflow['run']>[0]['payload']>;
	}
}
